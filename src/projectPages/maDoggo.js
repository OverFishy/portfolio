...
export function MaDoggo() {
  return (
    < ProjectPageStructureText
        ...
        projectWebStack={'For this project we used Ruby & Ruby on Rails, HTML, CSS, JS and SQL. My main task was to lead the backend progress, connect and work with the database and create the rough functionality. Later I switched to the frontend side for some pretty components.'}
        ...
        projectProblens={'As a student in a bootcamp, I was expected to perform some tasks outside my field of knowledge for this project. For this I had to deal with different new challenges, develop and implement solutions on the go, work with various APIs and data structures. '}
